...
const userValidator = {
    createAccount: [
        body('nickname').notEmpty().withMessage('Username is required').isString().withMessage('Username must be a string'),
    ...
    update: [
        ...
        body('nickname').optional().notEmpty().withMessage('Username cannot be empty').isString().withMessage('Username must be a string'),
